...
class Excel_EweiShopV2Model 
{
	...
	public function export($list, $params = array()) 
	{
		...
		$excel = new PHPExcel();
		$excel->getProperties()->setCreator('美德鲜生态农业互联网平台')->setLastModifiedBy('美德鲜生态农业互联网平台')->setTitle('Office 2007 XLSX Test Document')->setSubject('Office 2007 XLSX Test Document')->setDescription('Test document for Office 2007 XLSX, generated using PHP classes.')->setKeywords('office 2007 openxml php')->setCategory('report file');
